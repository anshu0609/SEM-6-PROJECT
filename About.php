...
<script>
  var myLandbot = new Landbot.Livechat({
    configUrl: 'https://your-landbot-url.json',
  });
</script>
...
<body>
    ...
    <product>
        <div class="product-heading">
            ...
            <H4>From being the pioneers in veneer business to being the leading furniture company and a lifestyle brand we have come a long way since then and the journey, so far, has been an enriching and memorable one.

                We currently have 55 stores across India along with a successful foray into the ecommerce biz with our website www.durian.in. With our state of the art production facilities that make everything ranging from ply, laminates, veneers to sofas, chairs, beds, tables along with a whole lot more. We have scaled up our growth exponentially, with six factories at present. This is the relentless pursuit of our vision to be one of the best interior solution providers that has made what Durian is today.</H4>
        </div>
    ...
    <product>
        <div class="product-heading">
            <h1>2025</h1>
          <ul>
            <li>We are constantly seeking to exceed our previous best, with creativity and imagination. By challenging the way we see and to things, it leads to fresh perspectives and new ideas that inspire business innovation drive sustainable efficiencies and deliver superior product offerings.</li>
        <li>What makes us different?</li>
        <li>5 Year Warranty : An assurance to take care of your furniture and you.</li>
        <li>WHITE GLOVE Delivery : We provide expert technicians to assemble your furniture with care in select cities.</li>
        <li>FREE Installation : We help you assemble your furniture free of cost.</li>
        <li>EASY Pay : With Easy Payment Options like Cash on Delivery and EMI, shopping is more convenient.</li>
        </ul>
        </div>
